...
let tc_to_string_argb =
  ...
  check_produces_string to_string_argb "#0a0b0304" "#0a0b0304" ;
  check_produces_string to_string_argb "#0b0304" "#ff0b0304"

let tc_to_string_rgb =
  Alcotest.test_case "Convert to RGB string" `Quick @@ fun () ->
  check_produces_string to_string_rgb "#0b0304" "#0b0304" ;
  check_produces_string to_string_rgb "#0a0b0304" "#0b0304"

let tc_to_string =
  Alcotest.test_case "Convert to ARGB or RGB string" `Quick @@ fun () ->
  check_produces_string to_string "#0a0b0304" "#0a0b0304" ;
  check_produces_string to_string "#0b0304" "#0b0304"
